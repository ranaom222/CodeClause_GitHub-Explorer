...
btn.addEventListener('click', async function(e){
    ...
    try{
        ...
        if(data.message === 'Not Found'){
            ...
            <div class="body">
                <div class="error">
                    <img src="./images-icons/not-found.png" alt="">
                    <div>
                        <h2>NOT FOUND</h2>
        ...
        `
            <tr>
                ...
                <td><img src='./images-icons/fork-icon.png' width='20px'> ${e.forks} </td>
                <td><img src='./images-icons/issue-icon.png' width='20px'> ${e.open_issues}</td>
                <td><img src='./images-icons/watch-icon.png' width='20px'> ${e.watchers}</td>
            </tr>
        `
